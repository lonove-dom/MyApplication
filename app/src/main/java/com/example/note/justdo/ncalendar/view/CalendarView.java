...
public abstract class CalendarView extends View {
    ...
    protected int TimeNotSelectCircleColor;//未选择时间时 圆的颜色
    protected int PastTimeCircleColor;//过去时间 圆的颜色
    ...
    public CalendarView(Context context) {
        ...
        TimeNotSelectCircleColor=Attrs.TimeNotSelectCircleColor;
        PastTimeCircleColor=Attrs.PastTimeCircleColor;
