package com.example.note.justdo.ncalendar.utils;
...
public class Utils {
    ...
    public static NCalendar getMonthCalendar(LocalDate date) {
        ...
        for (int i = 0; i < 42; i++) {
            ...
            dateList.add(date1);
            com.necer.ncalendar.utils.LunarCalendarUtils.Lunar lunar = com.necer.ncalendar.utils.LunarCalendarUtils.solarToLunar(new com.necer.ncalendar.utils.LunarCalendarUtils.Solar(date1.getYear(), date1.getMonthOfYear(), date1.getDayOfMonth()));
            String lunarDayString = com.necer.ncalendar.utils.LunarCalendarUtils.getLunarDayString(date1.getYear(), date1.getMonthOfYear(), date1.getDayOfMonth(), lunar.lunarYear, lunar.lunarMonth, lunar.lunarDay, lunar.isLeap);
