...
public abstract class CalendarPager extends ViewPager {
    ...
    public CalendarPager(Context context, AttributeSet attrs) {
        ...
        Attrs.TimeNotSelectCircleColor=ta.getColor(R.styleable.NCalendar_TimenotselectCircleColor,getResources().getColor(R.color.TimenotselectCircleColor));
        Attrs.PastTimeCircleColor=ta.getColor(R.styleable.NCalendar_PastTimeCircleColor,getResources().getColor(R.color.PastTimeCircleColor));
        ...
        Attrs.pointSize = ta.getDimension(R.styleable.NCalendar_pointSize, (int) Utils.dp2px(context, 3));
        ...
        Attrs.defaultCalendar = "Week".equals(defaultCalendar) ? com.necer.ncalendar.calendar.NCalendar.WEEK : NCalendar.MONTH;
    ...
    /*    List<String> formatList = new ArrayList<>();
        ...
        calendarView.setPointList(pointList);
    }
