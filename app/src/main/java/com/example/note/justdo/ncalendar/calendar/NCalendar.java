...
public class NCalendar extends FrameLayout implements NestedScrollingParent, ValueAnimator.AnimatorUpdateListener, OnWeekCalendarChangedListener, OnMonthCalendarChangedListener {
    ...
    public void setIsTimeSelected(Boolean isTimeSelected){
        monthCalendar.setIsTimeSelected(isTimeSelected);
        weekCalendar.setIsTimeSelected(isTimeSelected);
    }
    public void setIsTimeBeforecurrent(Boolean isTimeBeforecurrent){
        monthCalendar.setIsTimeBeforecurrent(isTimeBeforecurrent);
        weekCalendar.setIsTimeBeforecurrent(isTimeBeforecurrent);
    }
    public Boolean getIsTimeSelected(){
        return monthCalendar.getIsTimeSelected();
    }
    public Boolean getIsTimeBeforecurrent(){
        return monthCalendar.getIsTimeBeforecurrent();
    }
    @Override
    ...
    private int getMonthCalendarOffset() {
        MonthView currectMonthView = monthCalendar.getCurrentMonthView();
        //该月有几行
    ...
    public Boolean getDateClicked(){
        return STATE==MONTH?monthCalendar.getDateClicked():weekCalendar.getDateClicked();
    }
    public void setDateClicked(Boolean dateClicked){
        if(STATE==MONTH){
        monthCalendar.setDateClicked(dateClicked);}
        else if(STATE==WEEK){
        weekCalendar.setDateClicked(dateClicked);}
    }
