...
import com.example.note.justdo.Amap.adapter.InputTipsAdapter;
...
public class InputTipsActivity extends Activity implements SearchView.OnQueryTextListener, Inputtips.InputtipsListener, OnItemClickListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.amap_input_tips);
        initSearchView();
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        if (mCurrentTipList != null) {
            ...
            setResult(NewMap.RESULT_CODE_INPUTTIPS, intent);
            this.finish();
        }
    }
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        setResult(NewMap.RESULT_CODE_KEYWORDS, intent);
        this.finish();
        return false;
    }
